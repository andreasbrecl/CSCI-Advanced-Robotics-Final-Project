...
#ifdef DEBUG
const char LibraryVersion[] = "Phidget21 Debug - Version 2.1.9 - Built " __DATE__
    " " __TIME__;
#else
const char LibraryVersion[] = "Phidget21 - Version 2.1.9 - Built " __DATE__
    " " __TIME__;
#endif
...
const CPhidgetUniqueDeviceDef Phid_Unique_Device_Def[] = {
	...
	{PHIDUID_ADVANCEDSERVO_8MOTOR_VOLTAGE_CONTROL,		PHIDID_ADVANCEDSERVO_8MOTOR,			400,	500 },	// 400 - <500
	...
	{PHIDUID_SPATIAL_ACCEL_GYRO_COMPASS_1044_1,			PHIDID_SPATIAL_ACCEL_GYRO_COMPASS,		500,	600 },	// 500 - <600
